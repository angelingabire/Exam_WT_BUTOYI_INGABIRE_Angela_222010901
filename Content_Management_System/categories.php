...
<section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <label for="category_id">Categories id :</label>
        ...
        <input type="text" id="category_code" name="category_code" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO categories(category_id,category_name,category_code) VALUES (?, ?, ?)");
    $stmt->bind_param("isi", $category_id, $category_name,$category_code);

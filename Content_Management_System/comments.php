...
<section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <input type="number" id="article_id" name="article_id"><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO comments(comment_id,article_id,user_id,content,created_at) VALUES (?, ?, ?,?,?)");
    $stmt->bind_param("iiiss", $comment_id, $article_id,$user_i,$content,$created_at);
    ...
    <table border="6">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $coid = $row['comment_id']; // Fetch the comment_id
                echo "<tr>
                    ...
                    <td><a style='padding:4px' href='delete_comments.php?comment_id=$coid'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_comments.php?comment_id=$coid'>Update</a></td> 
                </tr>";
            }
        } else {

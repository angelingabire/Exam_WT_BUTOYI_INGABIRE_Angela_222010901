...
if (isset($_REQUEST['user_id'])) {
    ...
    if (isset($_REQUEST['confirm']) && $_REQUEST['confirm'] == 'yes') {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>alert('Error deleting data: " . $stmt->error . "'); window.location.href = 'users.php';</script>";
        }
        $stmt->close();
    } else {
    ...
    echo "<script>alert('User ID is not set.'); window.location.href = 'users.php';</script>";
}
